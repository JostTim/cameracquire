...
def command_dispatcher():
    ...
    parser_list_cameras = subparsers.add_parser(
        "list-cameras", help="List all available cameras")
    parser_list_cameras.set_defaults(func=list_cameras)

    parser_start = subparsers.add_parser(
        "start", help="Start acquiring images from a camera")
    ...
    parser_list_nodes = subparsers.add_parser(
        "list-nodes", help="List all available nodes for the selected camera")
